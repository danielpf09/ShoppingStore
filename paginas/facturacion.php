    ...
    <div id="factura">
      ...
      <table id="productos">
        ...
        <tr>
          ...
          <td id="cantidad_camisas"><?php echo isset($_SESSION['unidades']) ? $_SESSION['unidades'] : ''; ?></td>
          <td id="tallas"><?php echo isset($_SESSION['talla']) ? $_SESSION['talla'] : ''; ?></td>
          <td>COP 4,729,300</td>
          <td id="total_camisas">COP <?php echo isset($_SESSION['unidades']) && is_numeric($_SESSION['unidades']) ? number_format($_SESSION['unidades'] * 4729300, 0, ',', '.') : '0'; ?></td>
        </tr>
      </table>

      <div id="totales">
        <p>Subtotal: <span id="total_camisas">COP <?php echo isset($_SESSION['unidades']) && is_numeric($_SESSION['unidades']) ? number_format($_SESSION['unidades'] * 4729300, 0, ',', '.') : '0'; ?></span></p>
        <p>Impuestos: <span id="impuestos">$0</span></p>
        <p>Total: <span id="total_camisas">COP <?php echo isset($_SESSION['unidades']) && is_numeric($_SESSION['unidades']) ? number_format($_SESSION['unidades'] * 4729300, 0, ',', '.') : '0'; ?></span></p>
      </div>
    </div>
